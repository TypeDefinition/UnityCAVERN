...
namespace Spelunx
{
    public sealed class ViveTracker : MonoBehaviour
    {
        ...
        // This is present in the OVRT_Tracked_Device class
        // but I want it hidden, since I don't know what the usecase is
        // so now it's private :P
        private UnityEvent<int> onDeviceIndexChanged;
